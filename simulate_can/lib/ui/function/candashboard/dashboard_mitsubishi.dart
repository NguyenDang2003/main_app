...
class DashboardMitsubishi extends StatefulWidget {
  const DashboardMitsubishi({super.key});
  @override
  DashboardMitsubishiState createState() => DashboardMitsubishiState();
}

class DashboardMitsubishiState extends State<DashboardMitsubishi> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - MITSUBISHI',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
