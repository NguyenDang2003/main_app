...
class DashboardMercedes extends StatefulWidget {
  const DashboardMercedes({super.key});
  @override
  DashboardMercedesState createState() => DashboardMercedesState();
}

class DashboardMercedesState extends State<DashboardMercedes> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - MERCEDES',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
