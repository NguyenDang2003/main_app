...
class DashboardSuzuki extends StatefulWidget {
  const DashboardSuzuki({super.key});
  @override
  DashboardSuzukiState createState() => DashboardSuzukiState();
}

class DashboardSuzukiState extends State<DashboardSuzuki> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - SUZUKI',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
