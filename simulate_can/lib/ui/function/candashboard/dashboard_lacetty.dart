...
class DashboardLacetty extends StatefulWidget {
  const DashboardLacetty({super.key});
  @override
  DashboardLacettyState createState() => DashboardLacettyState();
}

class DashboardLacettyState extends State<DashboardLacetty> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - LACETTY',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
