...
class DashboardVolkswagen extends StatefulWidget {
  const DashboardVolkswagen({super.key});
  @override
  DashboardVolkswagenState createState() => DashboardVolkswagenState();
}

class DashboardVolkswagenState extends State<DashboardVolkswagen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - VOLKSWAGEN',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
