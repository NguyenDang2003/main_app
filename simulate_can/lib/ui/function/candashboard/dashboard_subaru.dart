...
class DashboardSubaru extends StatefulWidget {
  const DashboardSubaru({super.key});
  @override
  DashboardSubaruState createState() => DashboardSubaruState();
}

class DashboardSubaruState extends State<DashboardSubaru> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - SUBARU',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
