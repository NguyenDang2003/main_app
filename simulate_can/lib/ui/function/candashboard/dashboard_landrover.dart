...
class DashboardLandrover extends StatefulWidget {
  const DashboardLandrover({super.key});
  @override
  DashboardLandroverState createState() => DashboardLandroverState();
}

class DashboardLandroverState extends State<DashboardLandrover> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - LAND ROVER',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
