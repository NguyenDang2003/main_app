...
class DashboardVolvo extends StatefulWidget {
  const DashboardVolvo({super.key});
  @override
  DashboardVolvoState createState() => DashboardVolvoState();
}

class DashboardVolvoState extends State<DashboardVolvo> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - VOLVO',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
