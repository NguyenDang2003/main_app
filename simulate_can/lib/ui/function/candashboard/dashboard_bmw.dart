...
class DashboardBmw extends StatefulWidget {
  const DashboardBmw({super.key});
  @override
  DashboardBmwState createState() => DashboardBmwState();
}

class DashboardBmwState extends State<DashboardBmw> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - BMW',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
