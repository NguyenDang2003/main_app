...
class DashboardChevrolet extends StatefulWidget {
  const DashboardChevrolet({super.key});
  @override
  DashboardChevroletState createState() => DashboardChevroletState();
}

class DashboardChevroletState extends State<DashboardChevrolet> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - CHEVROLET',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
