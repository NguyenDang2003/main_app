...
class DashboardNissan extends StatefulWidget {
  const DashboardNissan({super.key});
  @override
  DashboardNissanState createState() => DashboardNissanState();
}

class DashboardNissanState extends State<DashboardNissan> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'DASHBOARD SIMULATE - NISSAN',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontSize: 40,
